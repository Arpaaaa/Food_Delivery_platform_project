/*
 Source Server      :39.101.64.202
 Source Host        :39.101.64.202:3306
...
(
    ...
    gender        TINYINT(4)  NOT NULL COMMENT 'gender 0 女 1 男',
    ...
    is_defalut    TINYINT(1)  NOT NULL DEFAULT '0' COMMENT '默认 0 否 1 是',
  ...
  DEFAULT CHARSET = utf8 COMMENT ='地址管理';

INSERT INTO address_book (id, user_id, consignee, gender, phone, province_code, province_name, city_code, city_name,
                          district_code, district_name, detail, label, is_defalut, create_time, update_time,
...
(
    ...
    name        VARCHAR(64)  NOT NULL PRIMARY KEY COMMENT '菜品名称',
...
(
    ...
    address_book_i BIGINT(20)     NOT NULL COMMENT '地址id',
